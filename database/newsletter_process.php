...
# 1/30: Added this log.
#
# Function: retrieve and process data inputs from newsletter.html
#
# 2/11: relocated database query to function in database/newsletterFunctions.php
# 
#
...
#---------------------------------------------------------------------------------#
    ...
    $emailVerify = filter_input(INPUT_GET, 'emailVerify');
    ...
    if ($firstName == null || $email == null ||
        ...
        if($error_message) {
            ...
            $firstName = SQLQuery($firstName, $email, $emailVerify);
            $message = 'Thanks for signing up ' . $firstName . ', you\'re on the list!';
        }
    }
//SQLQuery($firstName, $email, $emailVerify);
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <hr class="primary">
                    <p id="p2"></p>
                    <!--<p>Your email address has been added to the mailing list!</p>-->
                </div>
            </div>
        </div>
